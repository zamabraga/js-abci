...
//   https://tendermint.readthedocs.io/en/master/using-tendermint.html#broadcast-api
// For tests:
//     1 - run: dummy.exe  https://tendermint.readthedocs.io/en/master/getting-started.html#dummy-a-first-example
//     2 - run: tendermint.exe node
//
// RPC documentation
// https://tendermint.readthedocs.io/en/master/specification/rpc.html
...
class Client extends events.EventEmitter{
    ...
    makeRequest(method){
        ...
        const req = http.get(opt, (res) => {
            ...
            // console.log('git statusHEADERS: %j', res.headers);
